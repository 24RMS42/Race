...
//		public DateTime? GoesSecretEndDate { get; set; }
//        public DateTime LastRegisterDateTime { get; set; }
//        public DateTime ShowWinnerDateTime { get; set; }
//		public DateTime? ShowInvitationToExternalSiteDateTime { get; set; }
		[JsonProperty("MinutesRequiredForAnActivityToBeOk")]
		[XmlElement("MinutesRequiredForAnActivityToBeOk")]
...
//        public string BookingRaceTypeID { get; set; }
		[JsonProperty("isLoginPossible")]
		[XmlElement("isLoginPossible")]
		public bool IsLoginPossible { get; set; }
//        public bool isShowWinnersPossible { get; set; }
//        public bool isShowTeamScoresPossible { get; set; }
		[JsonProperty("isRegisterTrainingPossible")]
		[XmlElement("isRegisterTrainingPossible")]
...
//        public object CustomerPanel { get; set; }
