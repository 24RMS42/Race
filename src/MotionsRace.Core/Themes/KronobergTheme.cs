...
{
	public class KronobergTheme : ITheme
	{
		public string Name { get { return "Arbetspendling & hälsoutmaning"; } }
		public string SignUpURL { get { return "http://kronoberg.motionsrace.com/signup/"; } }
		public string ForgotPasswordURL { get { return "http://kronoberg.motionsrace.com/forgotpassword.aspx"; } }

		public IThemeColors Colors { get; set; }
		public IThemeImages Images { get; set; }

		public KronobergTheme()
		{
			Colors = new KronobergThemeColors();
			Images = new KronobergThemeImages();
		}

		public class KronobergThemeColors : IThemeColors
		{
			...
			public static readonly MvxColor COLOR_GREEN = new MvxColor(131, 184, 26); //#83B81A
			public static readonly MvxColor COLOR_DARKGREEN = new MvxColor(131, 184, 26);
		...
		public class KronobergThemeImages : IThemeImages
		{
			public string Logo { get { return @"kronoberg/twitchlogo.png"; } }

			public string FirstSlide { get { return @"kronoberg/slide1.png"; } }
			public string SecondSlide { get { return @"kronoberg/slide2.png"; } }
			public string ThirdSlide { get { return @"kronoberg/slide3.png"; } }

			public string LoginBackground { get { return @"kronoberg/loginBackground.png"; } }
			public string LoginLogo { get { return @"kronoberg/loginlogo.png"; } }

			public string HeaderLogo { get { return @"kronoberg/headerlogo.png"; } }
			public string HeaderRegister { get { return @"kronoberg/ic_plus.png"; } }
			public string HeaderRegisterFavorit { get { return @"kronoberg/ic_star.png"; } }
			public string HeaderGoToWeb { get { return @"kronoberg/ic_next.png"; } }

			public string Close { get { return @"kronoberg/ic_close.png"; } }

			public string TrainingCategoriesPath { get { return @"kronoberg/TraningCategories"; } }

			public string Face { get { return @"kronoberg/face.png"; } }
			public string CircleFace { get { return @"kronoberg/circleFace.png"; } }
		}
	}
}
