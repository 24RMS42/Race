...
{
	public class NordenMachineryTheme : ITheme
	{
		public string Name { get { return "Norden Activity Challenge"; } }
		public string SignUpURL { get { return "http://norden-challenge.com/login.aspx"; } }
		public string ForgotPasswordURL { get { return "http://norden-challenge.com/forgotpassword.aspx"; } }

		public IThemeColors Colors { get; set; }
		public IThemeImages Images { get; set; }

		public NordenMachineryTheme()
		{
			Colors = new NordenMachineryThemColors();
			Images = new NordenMachineryThemImages();
		}

		public class NordenMachineryThemColors : IThemeColors
		{
			...
			public static readonly MvxColor COLOR_GREEN = new MvxColor(207, 20, 43);
		...
		public class NordenMachineryThemImages : IThemeImages
		{
			public string Logo { get { return @"norden/twitchlogo.png"; } }

			public string FirstSlide { get { return @"norden/slide1.png"; } }
			public string SecondSlide { get { return @"norden/slide2.png"; } }
			public string ThirdSlide { get { return @"norden/slide3.png"; } }

			public string LoginBackground { get { return @"norden/loginBackground.png"; } }
			public string LoginLogo { get { return @"norden/loginlogo.png"; } }

			public string HeaderLogo { get { return @"norden/headerlogo.png"; } }
			public string HeaderRegister { get { return @"norden/ic_plus_red.png"; } }
			public string HeaderRegisterFavorit { get { return @"norden/ic_star_red.png"; } }
			public string HeaderGoToWeb { get { return @"norden/ic_next_red.png"; } }

			public string Close { get { return @"norden/ic_close.png"; } }

			public string TrainingCategoriesPath { get { return @"norden/TraningCategories"; } }

			public string Face { get { return @"norden/face.png"; } }
			public string CircleFace { get { return @"norden/circleFace.png"; } }
		}
	}
}
