...
namespace Cirrious.MvvmCross.Binding.Android.Views
{
	public static class MvxBindableListViewHelpers
	{
		...
		{
			var typedArray = context.ObtainStyledAttributes(attrs, MvxAndroidBindingResource.Instance.ListViewStylableGroupId);
			...
			try
			{
				...
				for (var i = 0; i < numStyles; ++i)
				{
					...
					if (attributeId == MvxAndroidBindingResource.Instance.ListItemTemplateId)
					{
